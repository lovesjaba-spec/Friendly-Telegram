...
class LoaderMod(loader.Module):
    ...
    strings = {
        ...
        "module_link": '📥 <a href="{}">Link</a> <b>for module {}:</b>\n<code>{}</code>',
        "not_found_info": "🚫 <b>Failed to find module with name</b> <code>{}</code><b>:</b>",
        "not_found_c_info": "🚫 <b>Failed to find module with command</b> <code>{}</code><b>:</b>",
        ...
        "repo_unloaded": "🔄 <b>Repository unloaded, restart required to unload its modules</b>",
    ...
    strings_ru = {
        "avail_header": "📥 <b>Доступные официальные модули из репозитория</b>",
        "select_preset": "⚠️ <b>Выберите пресет</b>",
        ...
        "provide_module": "⚠️ <b>Укажите модуль для загрузки</b>",
        "bad_unicode": "🚫 <b>Неверная Unicode-разметка в модуле</b>",
        "load_failed": "🚫 <b>Загрузка не удалась. Подробности в логах</b>",
        ...
        "no_modules": "⚠️ <b>У вас нет своих модулей!</b>",
        "searching": "🔍 <b>Поиск...</b>",
        "file": "📥 <b>Файл модуля {}:</b>",
        "module_link": '📥 <a href="{}">Ссылка</a> <b>на модуль {}:</b>\n<code>{}</code>',
        "not_found_info": "🚫 <b>Не удалось найти модуль с именем</b> <code>{}</code><b>:</b>",
        "not_found_c_info": "🚫 <b>Не удалось найти модуль с командой</b> <code>{}</code><b>:</b>",
        "not_found": "🚫 <b>Модуль не найден</b>",
        "file_core": "📥 <b>Файл системного модуля {}:</b>",
        "loading": "🔄 <b>Загрузка...</b>",
        "url_invalid": "🚫 <b>Неверная ссылка</b>",
        "args_incorrect": "🚫 <b>Неверные аргументы</b>",
        "repo_loaded": "✅ <b>Репозиторий загружен</b>",
        "repo_not_loaded": "🚫 <b>Репозиторий не загружен</b>",
        "repo_unloaded": "🔄 <b>Репозиторий выгружен, для выгрузки его модулей нужен перезапуск</b>",
        "repo_not_unloaded": "🚫 <b>Репозиторий не выгружен</b>",
        "undoc_cmd": "👁‍🗨 Нет описания",
        "undoc_ihandler": "👁‍🗨 Нет описания",
        "undoc_chandler": "👁‍🗨 Нет описания",
        "inline_init_failed": (
        ...
        "_cmd_doc_dlmod": "Скачивает и устанавливает модуль из официального репозитория",
        "_cmd_doc_dlpreset": "Устанавливает пресет. По умолчанию full",
        "_cmd_doc_loadmod": "Загружает файл модуля",
        "_cmd_doc_dlrepo": "Скачивает и устанавливает все модули из репозитория",
        "_cmd_doc_unloadrepo": "Удаляет загруженный репозиторий",
        "_cmd_doc_unloadmod": "Выгружает модуль по имени класса",
        "_cmd_doc_clearmodules": "Удаляет все установленные модули",
    }
